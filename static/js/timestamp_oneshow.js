...
var filename = "/"+document.getElementById("timestamponepath").value;

var time_format = document.getElementById("timstamp_format").value;
...
var parseTime = d3.timeParse(time_format);
